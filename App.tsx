...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-porcelain bg-paper-texture text-charcoal overflow-x-hidden relative">
      
      {/* Background Image Layer */}
      {/* Using the thumbnail endpoint is often more reliable for Drive hotlinking */}
      <div 
        className="fixed inset-0 z-0 pointer-events-none"
        style={{
          backgroundImage: `url('https://drive.google.com/thumbnail?id=1PS3Ccvyciq8UKKHmr0CDUC08IvhoBFbd&sz=w2560')`,
      ...
      <div className="relative z-10">
        ...
        <header className="min-h-screen flex flex-col justify-center items-center text-center px-4 relative pt-20">
          ...
          <div className="fade-in max-w-4xl mx-auto z-10">
            <div className="mb-6">
              <span className="inline-block px-4 py-1 border border-gold text-gold text-[10px] tracking-[0.3em] uppercase bg-white/80 backdrop-blur-sm">
        ...
        <section id="ceremony" className="py-24 container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20 max-w-6xl mx-auto">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
               <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full border-4 border-double border-gold overflow-hidden shadow-2xl bg-white">
                  <img 
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <div className="space-y-8 border-l-2 border-gold/30 pl-8 md:pl-12 py-4 bg-white/50 backdrop-blur-sm p-6 rounded-r-lg">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                     <a 
                        ...
                        className="inline-block px-4 py-2 border border-charcoal/30 text-[10px] uppercase tracking-widest hover:bg-gold hover:text-white hover:border-gold transition-all bg-white/50"
                      >
                        Google Calendar
                      </a>
                      <button 
                ...
                <div>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="inline-block px-6 py-2 border border-charcoal text-xs uppercase tracking-widest hover:bg-rouge hover:text-white hover:border-rouge transition-all bg-white/50"
                  >
                    View Map
                  </a>
                </div>
        ...
        {/* RSVP Section */}
        <section id="rsvp" className="py-20 bg-white/90 backdrop-blur-sm border-t border-gold/20">
        ...
        <footer className="bg-rouge text-porcelain py-12 text-center">
          ...
          <div className="flex justify-center items-center gap-4 text-[10px] uppercase tracking-widest opacity-70 mb-4">
          ...
          <button 
            ...
            className="text-[9px] text-white/30 uppercase tracking-[0.2em] hover:text-white transition-colors"
          >
            Admin Access
          </button>
        </footer>
